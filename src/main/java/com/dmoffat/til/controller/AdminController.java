...
/**
 * Handles all requests made to the administration area. 
 * @author danielmoffat
 *
 */
@Controller
...
public class AdminController {
	...
	@Autowired
	public AdminController(ThingService thingService) {
	...
	@RequestMapping(value="thing/delete", method=RequestMethod.POST)
	...
	@RequestMapping(value="thing/list", method=RequestMethod.GET)
